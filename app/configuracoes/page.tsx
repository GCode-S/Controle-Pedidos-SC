...
export default function ConfiguracoesPage() {
  ...
  return (
    <div className="p-4 md:p-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-foreground md:text-3xl">Configuracoes</h1>
        <p className="mt-1 text-muted-foreground">Personalize o aplicativo e gerencie seus dados</p>
      </div>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <Label htmlFor="theme-switch" className="cursor-pointer">Modo Escuro</Label>
              </div>
              <Switch
                id="theme-switch"
                checked={theme === 'dark'}
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>Exporte ou importe seus dados em formato JSON</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex flex-col gap-3 sm:flex-row">
              <Button onClick={handleExport} variant="outline" className="flex-1 gap-2 bg-transparent">
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>Informacoes sobre o sistema</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <p><strong className="text-foreground">Armazenamento:</strong> IndexedDB (local)</p>
